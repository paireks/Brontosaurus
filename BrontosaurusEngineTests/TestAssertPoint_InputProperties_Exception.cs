...
{
    public class TestAssertPoint_InputProperties_Exception : TheoryData<List<Point3d>, List<Point3d>, List<string>, double, string>
    {
        public TestAssertPoint_InputProperties_Exception()
        {
