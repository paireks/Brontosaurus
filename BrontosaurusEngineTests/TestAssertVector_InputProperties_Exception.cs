...
{
    public class TestAssertVector_InputProperties_Exception : TheoryData<List<Vector3d>, List<Vector3d>, List<string>, double, string>
    {
        public TestAssertVector_InputProperties_Exception()
        {
