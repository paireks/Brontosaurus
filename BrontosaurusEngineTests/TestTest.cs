...
namespace BrontosaurusEngineTests
{
    public class TestTest
    {
        ...
        public void TestAssertPoint_InputProperties_Helper(List<Point3d> exp, List<Point3d> act, List<string> names)
        {
            Test testObject = new Test(exp, act, names);
        ...
        public void TestAssertPoint_InputProperties_Exception_Helper(List<Point3d> exp, List<Point3d> act, List<string> names, string message)
        {
            var exception = Assert.Throws<ArgumentException>(() => new Test(exp,act, names));
            Assert.Equal(message, exception.Message);
        }
        ...
        public void TestAssertPoint_Result_Helper(List<Point3d> exp, List<Point3d> act, List<string> names, List<string> result)
        {
            Test testObject = new Test(exp, act, names);
            Assert.Equal(result, testObject.Result);
        }
        ...
        public void TestAssertPoint_Failed_Helper(List<Point3d> exp, List<Point3d> act, List<string> names, bool failed)
        {
            Test testObject = new Test(exp, act, names);
            Assert.Equal(failed, testObject.Failed);
        }
        ...
        public void TestAssertPoint_FailedInfo_Helper(List<Point3d> exp, List<Point3d> act, List<string> names, List<string> failedInfo)
        {
            Test testObject = new Test(exp, act, names);
            Assert.Equal(failedInfo, testObject.FailedInfo);
        }
        ...
        public void TestAssertVector_InputProperties_Helper(List<Vector3d> exp, List<Vector3d> act, List<string> names)
        {
            Test testObject = new Test(exp, act, names);
        ...
        public void TestAssertVector_InputProperties_Exception_Helper(List<Vector3d> exp, List<Vector3d> act, List<string> names, string message)
        {
            var exception = Assert.Throws<ArgumentException>(() => new Test(exp, act, names));
            Assert.Equal(message, exception.Message);
        }
        ...
        public void TestAssertVector_Result_Helper(List<Vector3d> exp, List<Vector3d> act, List<string> names, List<string> result)
        {
            Test testObject = new Test(exp, act, names);
            Assert.Equal(result, testObject.Result);
        }
        ...
        public void TestAssertVector_Failed_Helper(List<Vector3d> exp, List<Vector3d> act, List<string> names, bool failed)
        {
            Test testObject = new Test(exp, act, names);
            Assert.Equal(failed, testObject.Failed);
        }
        ...
        public void TestAssertVector_FailedInfo_Helper(List<Vector3d> exp, List<Vector3d> act, List<string> names, List<string> failedInfo)
        {
            Test testObject = new Test(exp, act, names);
            Assert.Equal(failedInfo, testObject.FailedInfo);
        }
